...
export default class DeveloperOptions extends Component<{ c: Context }> {
    ...
    toggle = () => {
        ...
        if (!this.props.c.S.get<boolean>('DEV_OPTIONS_ENABLED')) { //if not enabled yet
            if (confirm(this.props.c.L.are_you_sure_enable_dev_options)) {
                this.props.c.S.set('DEV_OPTIONS_ENABLED', true)
            }
        } else { // disable dev options (safe mode)
            this.props.c.S.set('DEV_OPTIONS_ENABLED', false)
        }
    ...
    render() {
        ...
        return (<div>
            ...
            <input onClick={this.toggle}
                ...
                type="checkbox" checked={this.props.c.S.get<boolean>('DEV_OPTIONS_ENABLED')} />
            ...
            <div style={this.props.c.S.get<boolean>('DEV_OPTIONS_ENABLED') ? Styles.visible : Styles.invisible}>
